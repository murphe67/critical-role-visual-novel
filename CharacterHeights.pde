static class CharacterHeights {
  ...
  static void Initialise() {
    ...
    Map.put("carver4", 4.0);
    Map.put("ogre", 12.0);
    Map.put("ogre_dead", 12.0);
    Map.put("goblin", 3.0);
    Map.put("naga", 12.0);
    Map.put("dwarfwoman1", 4.0);
    Map.put("adra", 4.0);
    Map.put("magrim", 4.2);
    Map.put("dwarfwoman2", 3.9);
    Map.put("dwarfwoman3", 4.2);
    Map.put("dwarfman1", 4.0);
    Map.put("dwarfman2", 4.1);
    Map.put("dwarfman3", 3.8);
    Map.put("dwarfman4", 4.0);
    Map.put("balgus", 4.0);
    Map.put("bear", 4.5);
    ...
    Map.put("hieris ", 3.7);
    Map.put("steddos", 4.3);
    Map.put("umberhulk", 12.0);
    Map.put("umberhulk_preview", 12.0);
    Map.put("snail", 1.0);
    Map.put("devourer", 3.0);
    Map.put("duergar", 4.0);
    Map.put("troll", 12.0);
    Map.put("clarota", 7.8);
    Map.put("panther", 3.5);
    Map.put("gianteagle", 11.0);
    Map.put("earthelemental", 11.0);
    Map.put("airelemental", 11.0);
    Map.put("duergar_general", 4.0);
    Map.put("duergar_general_big", 6.5);
    Map.put("mindflayer", 8.2);
    Map.put("bulette", 14.0);
    Map.put("rhino", 10.0);
    Map.put("ooze", 12.0);
    Map.put("ooze_small", 6.0);
    Map.put("ooze_tiny", 3.0);
    Map.put("hook_horror", 12.0);
    Map.put("duergar_caster", 4.1);
    Map.put("kima", 3.8);
    Map.put("kima_hidden", 3.8);
    Map.put("ulara", 4.0);
    Map.put("kvarn", 11.0);
